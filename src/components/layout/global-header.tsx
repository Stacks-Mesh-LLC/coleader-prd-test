					...
					<div className="relative z-10 grid grid-cols-[auto_1fr_auto] items-center gap-4 px-5 py-2">
						...
						{user ? (
							...
							>
								...
								<span className="ml-3 font-bold text-xl tracking-tight bg-gradient-to-br from-text-primary to-text-secondary bg-clip-text text-transparent flex-shrink-0 transition-all duration-300">
									coleader.dev
								</span>
